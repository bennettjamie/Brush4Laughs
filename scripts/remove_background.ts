...
const INPUT_PATH = path.join(process.cwd(), 'public/brush4laughs_logo.png');
const OUTPUT_PATH = path.join(process.cwd(), 'public/brush4laughs_logo.png'); // OVERWRITE directly as requested
